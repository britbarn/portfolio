...
<section class="hero-banner container">
	...
	<div class="employer-container flex">
		<div class="current-employer">
			<h3 class="employer-text">Currently Working:</h3>
			<a href="https://www.matchbookcreative.com" target="_blank">
				<img src="{{ asset('images/mb-logo.png') }}" class="employer-logo">
			</a>
		</div>
		<div class="previous-employer">
			<h3 class="employer-text">Previous Employers:</h3>
			<div class="previous-employer-container">
			...
			<a href="https://www.riverview.org" target="_blank">
				<img src="{{ asset('images/riverview-logo.jpg') }}" class="employer-logo">
			</a>
			</div>
		</div>
	</div>
